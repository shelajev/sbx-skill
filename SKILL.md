...
- Reconcile three sources in this order: installed CLI help for supported local syntax, current Docker docs for intended behavior, then this skill for workflow guidance. Call out a version mismatch instead of silently choosing one.
